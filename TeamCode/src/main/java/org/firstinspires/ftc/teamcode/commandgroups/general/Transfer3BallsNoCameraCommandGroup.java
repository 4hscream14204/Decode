...
public class Transfer3BallsNoCameraCommandGroup extends SequentialCommandGroup {
    public Transfer3BallsNoCameraCommandGroup(RobotBase robotBase){
        addCommands(
                new ParallelCommandGroup(new InstantCommand(()->robotBase.ejectorLeftSubsystem.setPosition(SorterServo.ServoPosition.LAUNCH)), new InstantCommand(()->robotBase.ejectorRightSubsystem.setPosition(SorterServo.ServoPosition.LAUNCH))),
