...
public class RedLLZone12BallAutoUpdated extends OpMode {
    ...
    Pose launchPose = new Pose(88, 93, Math.toRadians(47));
    ...
    Pose preIntakeTopRow = new Pose(94, 89, Math.toRadians(0));
    Pose intakeTopRow = new Pose(125, 89, Math.toRadians(0));
    Pose moveBackFromFirstRow = new Pose(92,84, Math.toRadians(90));
    Pose lineUpToOpenRamp = new Pose(125, 76, Math.toRadians(90));
    Pose openRamp = new Pose(127, 76, Math.toRadians(90));
    ...
    Pose preIntakeMiddleRow = new Pose(94, 64, Math.toRadians(0));
    Pose intakeMiddleRow = new Pose(132, 64, Math.toRadians(0));
    Pose backupMiddleRow = new Pose(114, 64, Math.toRadians(0));
    ...
    Pose preIntakeBottomRow = new Pose(94, 40, Math.toRadians(0));
    Pose intakeBottomRow = new Pose(132, 40, Math.toRadians(0));
