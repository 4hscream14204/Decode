...
public class PedroRoutes {
    ...
    public PathChain IntakeMiddleRow = follower.pathBuilder()
            .addPath(
                    new BezierLine(new Pose(104.845, 60.000), new Pose(128.791, 60.000)))
            .setTangentHeadingInterpolation()
            .build();

    public PathChain goToShoot = follower.pathBuilder()
            .addPath(
                    new BezierCurve(new Pose(128.791, 60.000), new Pose(76.369, 57.600), new Pose(80.575, 13.591)))
            .setTangentHeadingInterpolation()
            .build();

    public PathChain lineUpToThirdRow = follower.pathBuilder()
            .addPath(
                    new BezierCurve(
    ...
    public PathChain intakeThirdRow = follower.pathBuilder()
            .addPath(new BezierLine(new Pose(108.728, 36.243), new Pose(130.085, 36.000)))
            .setTangentHeadingInterpolation()
            .build();

    public PathChain lastTimeGoingToShoot = follower.pathBuilder()
