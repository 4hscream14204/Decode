...
public class RGBLightMiddleColorCommandGroup extends SequentialCommandGroup {
    public RGBLightMiddleColorCommandGroup(RobotBase robotBase){
        if(robotBase.sorterCameraSubsystem.getClosestSwatchMiddle() == PredominantColorProcessor.Swatch.ARTIFACT_GREEN){
            addCommands(
            ...
            addCommands(
                    new InstantCommand(()->robotBase.RGBLightMiddleSubsystem.setColor(RGBLightSubsystem.Colors.RED))
            );
        }
    }
}
