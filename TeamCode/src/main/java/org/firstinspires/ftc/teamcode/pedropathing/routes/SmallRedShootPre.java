...
public class SmallRedShootPre extends OpMode {
   ...
   // Pose intakePose = new Pose(133,6.5,Math.toRadians(0));
    ...
    Pose park = new Pose (16,14,Math.toRadians(0));
   ...
   // PathChain goesBackToShoot;
    ...
    public void init() {
        ...
        Parks = follower.pathBuilder()
                .addPath(new BezierLine(preloadLaunchPose,park))
                .setLinearHeadingInterpolation(preloadLaunchPose.getHeading(), park.getHeading())
                .build();
        ...
        route = new SequentialCommandGroup(
                ...
                new FollowPathCommand(follower,Parks,true,1)
        );
