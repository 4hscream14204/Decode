...
public class SmallBlueAutoRouteHP {
    ...
    Pose preloadLaunchPose = new Pose(87,14,Math.toRadians(64)).mirror();
    Pose intakePose = new Pose(129,6.5,Math.toRadians(0)).mirror();
    Pose launchPose = new Pose(89,14,Math.toRadians(64)).mirror();
    Pose parkPose = new Pose(119, 12, Math.toRadians(0)).mirror();
