...
public class BlueLargeLaunchZone12Artifacts extends OpMode {
    ...
    Pose launchPreload = new Pose(44,92,Math.toRadians(136));
    Pose launchPose1 = new Pose(44, 86, Math.toRadians(135));
    Pose launchPose2 = new Pose(41,88,Math.toRadians(138));
    Pose launchPose3 = new Pose(45,86,Math.toRadians(139));
    Pose launchPose4 = new Pose(45,86,Math.toRadians(138));
    ...
    Pose preIntakeTopRow = new Pose(94, 77, Math.toRadians(0)).mirror();
    Pose intakeTopRow = new Pose(125, 77, Math.toRadians(0)).mirror();
    Pose moveBackFromFirstRow = new Pose(92,84, Math.toRadians(90)).mirror();
    Pose lineUpToOpenRamp = new Pose(122, 76, Math.toRadians(90)).mirror();
    Pose openRamp = new Pose(134, 76, Math.toRadians(90)).mirror();
    ...
    Pose preIntakeMiddleRow = new Pose(94, 51, Math.toRadians(0)).mirror();
    Pose intakeMiddleRow = new Pose(132, 51, Math.toRadians(0)).mirror();
    Pose backupMiddleRow = new Pose(114, 51, Math.toRadians(0)).mirror();
    ...
    Pose preIntakeBottomRow = new Pose(94, 32, Math.toRadians(0)).mirror();
    Pose intakeBottomRow = new Pose(135, 32, Math.toRadians(0)).mirror();
    Pose backsUpFromBottomRow = new Pose(104,32,Math.toRadians(0)).mirror();
    ...
    int secondsToWait = 0;
    double dblLaucnhVel = 1835;
    double dblPreLaucnhVel = 1830;
    ElapsedTime timer;
    Servo prism;
    ...
    public void init() {
        ...
        linesUpToIntakeFirstRow = follower.pathBuilder()
                .addPath(new BezierLine(launchPose1, preIntakeTopRow))
                .setLinearHeadingInterpolation(launchPose1.getHeading(), preIntakeTopRow.getHeading())
