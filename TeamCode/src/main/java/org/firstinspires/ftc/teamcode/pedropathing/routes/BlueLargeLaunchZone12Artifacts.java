...
public class BlueLargeLaunchZone12Artifacts extends OpMode {
    ...
    Pose launchPreload = new Pose(49,92,Math.toRadians(131));
    Pose launchPose1 = new Pose(49, 86, Math.toRadians(131));
    Pose launchPose2 = new Pose(45,88,Math.toRadians(133));
    Pose launchPose3 = new Pose(49,86,Math.toRadians(134));
    Pose launchPose4 = new Pose(49,86,Math.toRadians(134));
