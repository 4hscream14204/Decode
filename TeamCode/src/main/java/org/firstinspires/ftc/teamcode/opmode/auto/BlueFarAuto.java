...
public class BlueFarAuto extends OpMode {
    ...
    Pose startPose = new Pose(90, 10, Math.toRadians(90)).mirror();
    Pose LaunchPose = new Pose(84, 18, Math.toRadians(0)).mirror();
    Pose goalPose = new Pose(144, 138);

    BezierLine startToLaunch = new BezierLine(startPose, new Pose(84, 18, Math.toRadians(0)).mirror());

    BezierLine preIntakeLastRow = new BezierLine(
            new Pose(84, 18,Math.toRadians(0)).mirror(),
            new Pose(101, 36).mirror());

    BezierLine intakeLastRow = new BezierLine(
            new Pose(101,36).mirror(),
            new Pose(127,36).mirror());
